...
describe('Float16Array', () => {
    ...
    it('set & get values', () => {
        ...
        float16[Infinity] = 3;
        assert(_rec65._expr(_rec65._capt(_rec65._capt(_rec65._capt(float16, 'arguments/0/left/object')[_rec65._capt(Infinity, 'arguments/0/left/property')], 'arguments/0/left') === _rec65._capt(undefined, 'arguments/0/right'), 'arguments/0'), {
            content: 'assert(float16[Infinity] === undefined)',
            filepath: 'test/Float16Array.js',
            line: 265
        }));
        float16['-0'] = 4;
        assert(_rec66._expr(_rec66._capt(_rec66._capt(_rec66._capt(float16, 'arguments/0/left/object')['-0'], 'arguments/0/left') === _rec66._capt(undefined, 'arguments/0/right'), 'arguments/0'), {
