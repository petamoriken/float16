...
(function () {
    ...
    function deepEqualNumberArray(x, y) {
        ...
        for (let i = 0, l = x.length; i < l; ++i) {
            ...
            if (val_x === 0 && val_y === 0) {
                assert(_rec5._expr(_rec5._capt(_rec5._capt(_rec5._capt(_rec5._capt(Object, 'arguments/0/left/left/callee/object').is(_rec5._capt(val_x, 'arguments/0/left/left/arguments/0'), 0), 'arguments/0/left/left') && _rec5._capt(_rec5._capt(Object, 'arguments/0/left/right/callee/object').is(_rec5._capt(val_y, 'arguments/0/left/right/arguments/0'), 0), 'arguments/0/left/right'), 'arguments/0/left') || _rec5._capt(_rec5._capt(_rec5._capt(Object, 'arguments/0/right/left/callee/object').is(_rec5._capt(val_x, 'arguments/0/right/left/arguments/0'), _rec5._capt(-0, 'arguments/0/right/left/arguments/1')), 'arguments/0/right/left') && _rec5._capt(_rec5._capt(Object, 'arguments/0/right/right/callee/object').is(_rec5._capt(val_y, 'arguments/0/right/right/arguments/0'), _rec5._capt(-0, 'arguments/0/right/right/arguments/1')), 'arguments/0/right/right'), 'arguments/0/right'), 'arguments/0'), {
                    content: 'assert(Object.is(val_x, 0) && Object.is(val_y, 0) || Object.is(val_x, -0) && Object.is(val_y, -0))',
                    filepath: 'test/Float16Array.js',
                    line: 25
                }));
            }
