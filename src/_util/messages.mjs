...
export const PROPERTY_IS_NOT_CALLABLE = "Property is not callable";
export const UNEXPECTED_NON_FUNCTION_IS_GIVEN = "Unexpected non-function is given";
export const ITERATOR_RESULT_IS_NOT_AN_OBJECT = "Iterator result is not an object";
...
export const THE_ALLOWED_ARRAY_SIZE_HAS_BEEN_EXCEEDED =
  "The allowed array size has been exceeded";
